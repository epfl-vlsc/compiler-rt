...
set(ALL_HPLGST_SUPPORTED_ARCH ${X86_64})
...
if(APPLE)
  ...
  filter_available_targets(HPLGST_SUPPORTED_ARCH ${ALL_HPLGST_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;tsan;safestack;cfi;esan;hplgst;scudo)
