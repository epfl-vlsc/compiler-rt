...
set(ALL_MEMORO_SUPPORTED_ARCH ${X86_64})
...
if(APPLE)
  ...
  set(MEMORO_COMMON_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
  ...
  list_intersect(LSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(MEMORO_SUPPORTED_ARCH
    ALL_MEMORO_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(LSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(MEMORO_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  ...
  filter_available_targets(MEMORO_SUPPORTED_ARCH ${ALL_MEMORO_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;esan;memoro;scudo;ubsan_minimal)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND MEMORO_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Darwin|Linux")
  set(COMPILER_RT_HAS_MEMORO TRUE)
else()
  set(COMPILER_RT_HAS_MEMORO FALSE)
endif()
