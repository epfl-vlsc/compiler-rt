...
if(APPLE)
  ...
  set(ALL_HPLGST_SUPPORTED_ARCH ${X86} ${X86_64} ${MIPS64} ${ARM64})
else()
  set(ALL_LSAN_SUPPORTED_ARCH ${X86} ${X86_64} ${MIPS64} ${ARM64} ${ARM32})
  set(ALL_HPLGST_SUPPORTED_ARCH ${X86} ${X86_64} ${MIPS64} ${ARM64} ${ARM32})
endif()
...
if(APPLE)
  ...
  set(HPLGST_COMMON_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
  set(UBSAN_COMMON_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
  list_intersect(ASAN_SUPPORTED_ARCH
    ALL_ASAN_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(HPLGST_SUPPORTED_ARCH
          ALL_HPLGST_SUPPORTED_ARCH
          SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(LSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(HPLGST_COMMON_SUPPORTED_ARCH
          ${SANITIZER_COMMON_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;tsan;safestack;cfi;esan;scudo;hplgst)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND HPLGST_SUPPORTED_ARCH AND
  OS_NAME MATCHES "Darwin|Linux|FreeBSD")
  set(COMPILER_RT_HAS_HPLGST TRUE)
else()
  set(COMPILER_RT_HAS_HPLGST FALSE)
endif()
message(STATUS "hplgst is : ${COMPILER_RT_HAS_HPLGST}")
